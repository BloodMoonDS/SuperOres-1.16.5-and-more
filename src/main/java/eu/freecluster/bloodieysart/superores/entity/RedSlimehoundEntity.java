...
import eu.freecluster.bloodieysart.superores.entity.renderer.RedSlimehoundRenderer;
import eu.freecluster.bloodieysart.superores.SuperoresModElements;

@SuperoresModElements.ModElement.Tag
public class RedSlimehoundEntity extends SuperoresModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("red_slimehound").setRegistryName("red_slimehound");

	public RedSlimehoundEntity(SuperoresModElements instance) {
		super(instance, 163);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RedSlimehoundRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -52429, -26215, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("red_slimehound_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, VillagerEntity.class, true, true));
			this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, AnimalEntity.class, true, false));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.MAGMA_CREAM));
		}
