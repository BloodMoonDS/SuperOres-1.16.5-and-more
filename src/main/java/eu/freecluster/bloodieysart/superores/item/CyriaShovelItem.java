...
public class CyriaShovelItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:cyria_shovel")
	public static final Item block = null;

	public CyriaShovelItem(SuperoresModElements instance) {
		super(instance, 477);
	}
