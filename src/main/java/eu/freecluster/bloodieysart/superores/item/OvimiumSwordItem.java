...
public class OvimiumSwordItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ovimium_sword")
	public static final Item block = null;

	public OvimiumSwordItem(SuperoresModElements instance) {
		super(instance, 392);
	}
