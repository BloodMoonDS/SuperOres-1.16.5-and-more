...
public class OvimiumPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ovimium_pickaxe")
	public static final Item block = null;

	public OvimiumPickaxeItem(SuperoresModElements instance) {
		super(instance, 390);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("ovimium_pickaxe"));
	}
}
