...
public class CandyStoneShovelItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:candy_stone_shovel")
	public static final Item block = null;

	public CandyStoneShovelItem(SuperoresModElements instance) {
		super(instance, 76);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("candy_stone_shovel"));
	}
}
