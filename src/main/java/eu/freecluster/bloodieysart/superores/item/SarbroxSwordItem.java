...
public class SarbroxSwordItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:sarbrox_sword")
	public static final Item block = null;

	public SarbroxSwordItem(SuperoresModElements instance) {
		super(instance, 413);
	}
