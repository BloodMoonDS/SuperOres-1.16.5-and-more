...
public class SarbroxPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:sarbrox_pickaxe")
	public static final Item block = null;

	public SarbroxPickaxeItem(SuperoresModElements instance) {
		super(instance, 411);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("sarbrox_pickaxe"));
	}
}
