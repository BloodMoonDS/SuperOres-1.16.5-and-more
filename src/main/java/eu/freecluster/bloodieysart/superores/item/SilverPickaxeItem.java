...
public class SilverPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:silver_pickaxe")
	public static final Item block = null;

	public SilverPickaxeItem(SuperoresModElements instance) {
		super(instance, 267);
	}
