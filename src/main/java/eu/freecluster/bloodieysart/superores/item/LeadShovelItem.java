...
public class LeadShovelItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lead_shovel")
	public static final Item block = null;

	public LeadShovelItem(SuperoresModElements instance) {
		super(instance, 12);
	}
