...
public class CandyStoneHoeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:candy_stone_hoe")
	public static final Item block = null;

	public CandyStoneHoeItem(SuperoresModElements instance) {
		super(instance, 77);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("candy_stone_hoe"));
	}
}
