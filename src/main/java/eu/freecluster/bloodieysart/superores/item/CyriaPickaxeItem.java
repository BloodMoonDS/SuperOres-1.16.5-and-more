...
public class CyriaPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:cyria_pickaxe")
	public static final Item block = null;

	public CyriaPickaxeItem(SuperoresModElements instance) {
		super(instance, 474);
	}
