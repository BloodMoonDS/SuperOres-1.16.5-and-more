...
public class DoomAxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:doom_axe")
	public static final Item block = null;

	public DoomAxeItem(SuperoresModElements instance) {
		super(instance, 433);
	}
