...
public class CandyStoneSwordItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:candy_stone_sword")
	public static final Item block = null;

	public CandyStoneSwordItem(SuperoresModElements instance) {
		super(instance, 75);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("candy_stone_sword"));
	}
}
