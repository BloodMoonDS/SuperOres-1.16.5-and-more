...
public class TitaniumArmorItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:titanium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("superores:titanium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("superores:titanium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("superores:titanium_armor_boots")
	public static final Item boots = null;

	public TitaniumArmorItem(SuperoresModElements instance) {
		super(instance, 298);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "superores:textures/models/armor/titanium_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
