...
public class TitaniumAxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:titanium_axe")
	public static final Item block = null;

	public TitaniumAxeItem(SuperoresModElements instance) {
		super(instance, 289);
	}
