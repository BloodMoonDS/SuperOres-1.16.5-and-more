...
public class OvimiumAxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ovimium_axe")
	public static final Item block = null;

	public OvimiumAxeItem(SuperoresModElements instance) {
		super(instance, 391);
	}
