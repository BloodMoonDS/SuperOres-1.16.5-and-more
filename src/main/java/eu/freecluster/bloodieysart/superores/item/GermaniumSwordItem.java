...
public class GermaniumSwordItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:germanium_sword")
	public static final Item block = null;

	public GermaniumSwordItem(SuperoresModElements instance) {
		super(instance, 350);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("germanium_sword"));
	}
}
