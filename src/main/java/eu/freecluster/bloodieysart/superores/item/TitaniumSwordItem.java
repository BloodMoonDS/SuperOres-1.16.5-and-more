...
public class TitaniumSwordItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:titanium_sword")
	public static final Item block = null;

	public TitaniumSwordItem(SuperoresModElements instance) {
		super(instance, 290);
	}
