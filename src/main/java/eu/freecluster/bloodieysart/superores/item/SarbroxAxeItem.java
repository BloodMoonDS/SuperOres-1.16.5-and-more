...
public class SarbroxAxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:sarbrox_axe")
	public static final Item block = null;

	public SarbroxAxeItem(SuperoresModElements instance) {
		super(instance, 412);
	}
