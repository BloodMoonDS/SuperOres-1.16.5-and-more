...
public class DoomShovelItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:doom_shovel")
	public static final Item block = null;

	public DoomShovelItem(SuperoresModElements instance) {
		super(instance, 435);
	}
