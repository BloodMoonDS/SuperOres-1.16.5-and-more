...
public class BloodStoneHoeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:blood_stone_hoe")
	public static final Item block = null;

	public BloodStoneHoeItem(SuperoresModElements instance) {
		super(instance, 548);
	}
