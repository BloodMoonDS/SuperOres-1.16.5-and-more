...
public class OdrimiumPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:odrimium_pickaxe")
	public static final Item block = null;

	public OdrimiumPickaxeItem(SuperoresModElements instance) {
		super(instance, 115);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("odrimium_pickaxe"));
	}
}
