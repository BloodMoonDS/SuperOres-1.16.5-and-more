...
public class ZoneexSwordItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:zoneex_sword")
	public static final Item block = null;

	public ZoneexSwordItem(SuperoresModElements instance) {
		super(instance, 311);
	}
