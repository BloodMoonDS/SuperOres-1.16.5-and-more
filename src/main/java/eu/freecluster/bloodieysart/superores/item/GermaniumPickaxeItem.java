...
public class GermaniumPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:germanium_pickaxe")
	public static final Item block = null;

	public GermaniumPickaxeItem(SuperoresModElements instance) {
		super(instance, 348);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("germanium_pickaxe"));
	}
}
