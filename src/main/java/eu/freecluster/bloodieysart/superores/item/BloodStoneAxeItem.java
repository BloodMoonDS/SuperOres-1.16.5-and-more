...
public class BloodStoneAxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:blood_stone_axe")
	public static final Item block = null;

	public BloodStoneAxeItem(SuperoresModElements instance) {
		super(instance, 545);
	}
