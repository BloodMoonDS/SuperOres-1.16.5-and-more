...
public class CandyStonePickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:candy_stone_pickaxe")
	public static final Item block = null;

	public CandyStonePickaxeItem(SuperoresModElements instance) {
		super(instance, 73);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("candy_stone_pickaxe"));
	}
}
