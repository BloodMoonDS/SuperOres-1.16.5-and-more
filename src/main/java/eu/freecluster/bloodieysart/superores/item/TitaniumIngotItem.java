...
public class TitaniumIngotItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:titanium_ingot")
	public static final Item block = null;

	public TitaniumIngotItem(SuperoresModElements instance) {
		super(instance, 282);
	}
