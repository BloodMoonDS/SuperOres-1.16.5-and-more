...
public class SilverIngotItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:silver_ingot")
	public static final Item block = null;

	public SilverIngotItem(SuperoresModElements instance) {
		super(instance, 261);
	}
