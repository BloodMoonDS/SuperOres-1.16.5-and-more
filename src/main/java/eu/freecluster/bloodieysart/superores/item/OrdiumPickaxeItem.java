...
public class OrdiumPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ordium_pickaxe")
	public static final Item block = null;

	public OrdiumPickaxeItem(SuperoresModElements instance) {
		super(instance, 94);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("ordium_pickaxe"));
	}
}
