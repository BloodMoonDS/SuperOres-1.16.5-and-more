...
public class DoomHoeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:doom_hoe")
	public static final Item block = null;

	public DoomHoeItem(SuperoresModElements instance) {
		super(instance, 436);
	}
