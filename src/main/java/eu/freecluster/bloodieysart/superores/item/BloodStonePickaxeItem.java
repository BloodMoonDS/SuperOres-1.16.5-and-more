...
public class BloodStonePickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:blood_stone_pickaxe")
	public static final Item block = null;

	public BloodStonePickaxeItem(SuperoresModElements instance) {
		super(instance, 544);
	}
