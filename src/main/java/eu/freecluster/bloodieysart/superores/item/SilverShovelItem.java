...
public class SilverShovelItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:silver_shovel")
	public static final Item block = null;

	public SilverShovelItem(SuperoresModElements instance) {
		super(instance, 270);
	}
