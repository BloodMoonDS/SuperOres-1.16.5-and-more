...
public class OvimiumHoeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ovimium_hoe")
	public static final Item block = null;

	public OvimiumHoeItem(SuperoresModElements instance) {
		super(instance, 394);
	}
