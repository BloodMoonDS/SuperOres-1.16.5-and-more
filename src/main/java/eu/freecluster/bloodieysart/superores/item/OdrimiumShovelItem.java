...
public class OdrimiumShovelItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:odrimium_shovel")
	public static final Item block = null;

	public OdrimiumShovelItem(SuperoresModElements instance) {
		super(instance, 118);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("odrimium_shovel"));
	}
}
