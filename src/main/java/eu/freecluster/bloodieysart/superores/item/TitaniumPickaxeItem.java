...
public class TitaniumPickaxeItem extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:titanium_pickaxe")
	public static final Item block = null;

	public TitaniumPickaxeItem(SuperoresModElements instance) {
		super(instance, 288);
	}
