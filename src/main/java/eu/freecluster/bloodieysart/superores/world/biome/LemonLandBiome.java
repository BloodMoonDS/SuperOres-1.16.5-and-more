...
import eu.freecluster.bloodieysart.superores.block.LemonWoodLogBlock;
import eu.freecluster.bloodieysart.superores.block.LemonWoodLeavesBlock;
import eu.freecluster.bloodieysart.superores.SuperoresModElements;

import com.google.common.collect.ImmutableList;

@SuperoresModElements.ModElement.Tag
public class LemonLandBiome extends SuperoresModElements.ModElement {
	public static Biome biome;

	public LemonLandBiome(SuperoresModElements instance) {
		super(instance, 150);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(LemonWoodLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(LemonWoodLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("superores:lemon_land"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("lemon_land_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("lemon_land_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("lemon_land_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = LemonWoodLeavesBlock.block.getDefaultState();
