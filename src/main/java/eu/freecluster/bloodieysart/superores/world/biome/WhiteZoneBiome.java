...
public class WhiteZoneBiome extends SuperoresModElements.ModElement {
	public static Biome biome;

	public WhiteZoneBiome(SuperoresModElements instance) {
		super(instance, 167);
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-1).setWaterColor(-1).setWaterFogColor(-1).withSkyColor(-1)
						...
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("superores:mus_chng")),
								12000, 24000, true))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("superores:white_zone"));
			}
		}
	}
