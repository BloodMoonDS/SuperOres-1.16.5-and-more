...
import eu.freecluster.bloodieysart.superores.block.TimeWoodLogBlock;
import eu.freecluster.bloodieysart.superores.block.TimeWoodLeavesBlock;
import eu.freecluster.bloodieysart.superores.SuperoresModElements;

import com.google.common.collect.ImmutableList;

@SuperoresModElements.ModElement.Tag
public class TimeLandBiome extends SuperoresModElements.ModElement {
	public static Biome biome;

	public TimeLandBiome(SuperoresModElements instance) {
		super(instance, 253);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3355393).setWaterColor(-16777012).setWaterFogColor(-16777012)
						.withSkyColor(-3355393).withFoliageColor(-6697984).withGrassColor(-6697984).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.PODZOL.getDefaultState(),
								Blocks.COARSE_DIRT.getDefaultState(), Blocks.WATER.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(TimeWoodLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(TimeWoodLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("superores:time_land"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("time_land_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("time_land_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("time_land_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
