...
public class TimeWoodFenceBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:time_wood_fence")
	public static final Block block = null;

	public TimeWoodFenceBlock(SuperoresModElements instance) {
		super(instance, 239);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("time_wood_fence");
		}
