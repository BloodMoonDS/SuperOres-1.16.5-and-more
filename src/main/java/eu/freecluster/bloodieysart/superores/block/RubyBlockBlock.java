...
public class RubyBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ruby_block")
	public static final Block block = null;

	public RubyBlockBlock(SuperoresModElements instance) {
		super(instance, 326);
	}
