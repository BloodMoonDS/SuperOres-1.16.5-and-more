...
public class OrdiumBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ordium_block")
	public static final Block block = null;

	public OrdiumBlockBlock(SuperoresModElements instance) {
		super(instance, 90);
	}
