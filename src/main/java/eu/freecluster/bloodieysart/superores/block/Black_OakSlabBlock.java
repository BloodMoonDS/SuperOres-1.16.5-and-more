...
public class Black_OakSlabBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_slab")
	public static final Block block = null;

	public Black_OakSlabBlock(SuperoresModElements instance) {
		super(instance, 205);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("black_oak_slab");
		}
