...
public class LemonWoodButtonBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_button")
	public static final Block block = null;

	public LemonWoodButtonBlock(SuperoresModElements instance) {
		super(instance, 139);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_button");
		}
