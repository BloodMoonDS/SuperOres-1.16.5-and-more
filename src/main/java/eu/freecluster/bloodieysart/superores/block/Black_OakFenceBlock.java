...
public class Black_OakFenceBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_fence")
	public static final Block block = null;

	public Black_OakFenceBlock(SuperoresModElements instance) {
		super(instance, 206);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("black_oak_fence");
		}
