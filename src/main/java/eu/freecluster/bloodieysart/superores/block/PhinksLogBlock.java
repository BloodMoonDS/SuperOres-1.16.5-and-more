...
public class PhinksLogBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_log")
	public static final Block block = null;

	public PhinksLogBlock(SuperoresModElements instance) {
		super(instance, 567);
	}
