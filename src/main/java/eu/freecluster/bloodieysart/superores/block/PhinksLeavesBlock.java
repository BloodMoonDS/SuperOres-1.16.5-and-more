...
public class PhinksLeavesBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_leaves")
	public static final Block block = null;

	public PhinksLeavesBlock(SuperoresModElements instance) {
		super(instance, 569);
	}
