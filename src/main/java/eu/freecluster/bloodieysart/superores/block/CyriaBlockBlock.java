...
public class CyriaBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:cyria_block")
	public static final Block block = null;

	public CyriaBlockBlock(SuperoresModElements instance) {
		super(instance, 470);
	}
