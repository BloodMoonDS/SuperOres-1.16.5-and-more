...
public class CandyStoneBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:candy_stone_block")
	public static final Block block = null;

	public CandyStoneBlockBlock(SuperoresModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("candy_stone_block");
		}
