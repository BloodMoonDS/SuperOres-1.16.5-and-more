...
public class LemonWoodPressurePlateBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_pressure_plate")
	public static final Block block = null;

	public LemonWoodPressurePlateBlock(SuperoresModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_pressure_plate");
		}
