...
public class SilverBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:silver_block")
	public static final Block block = null;

	public SilverBlockBlock(SuperoresModElements instance) {
		super(instance, 263);
	}
