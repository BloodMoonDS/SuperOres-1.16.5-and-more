...
public class LemonWoodStairsBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_stairs")
	public static final Block block = null;

	public LemonWoodStairsBlock(SuperoresModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_stairs");
		}
