...
public class LeadBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lead_block")
	public static final Block block = null;

	public LeadBlockBlock(SuperoresModElements instance) {
		super(instance, 5);
	}
