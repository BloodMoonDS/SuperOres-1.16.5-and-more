...
public class LemonWoodFenceBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_fence")
	public static final Block block = null;

	public LemonWoodFenceBlock(SuperoresModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_fence");
		}
