...
public class BloodStoneBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:blood_stone_block")
	public static final Block block = null;

	public BloodStoneBlockBlock(SuperoresModElements instance) {
		super(instance, 540);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blood_stone_block");
		}
