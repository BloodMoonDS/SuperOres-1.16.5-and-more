...
public class PhinksSlabBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_slab")
	public static final Block block = null;

	public PhinksSlabBlock(SuperoresModElements instance) {
		super(instance, 571);
	}
