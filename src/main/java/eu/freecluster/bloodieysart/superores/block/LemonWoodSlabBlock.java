...
public class LemonWoodSlabBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_slab")
	public static final Block block = null;

	public LemonWoodSlabBlock(SuperoresModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_slab");
		}
