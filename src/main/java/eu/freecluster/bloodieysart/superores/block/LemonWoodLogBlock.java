...
public class LemonWoodLogBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_log")
	public static final Block block = null;

	public LemonWoodLogBlock(SuperoresModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_log");
		}
