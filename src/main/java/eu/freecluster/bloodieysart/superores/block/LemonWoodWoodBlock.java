...
public class LemonWoodWoodBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_wood")
	public static final Block block = null;

	public LemonWoodWoodBlock(SuperoresModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_wood");
		}
