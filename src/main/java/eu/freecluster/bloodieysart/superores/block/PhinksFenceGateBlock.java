...
public class PhinksFenceGateBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_fence_gate")
	public static final Block block = null;

	public PhinksFenceGateBlock(SuperoresModElements instance) {
		super(instance, 573);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("phinks_fence_gate");
		}
