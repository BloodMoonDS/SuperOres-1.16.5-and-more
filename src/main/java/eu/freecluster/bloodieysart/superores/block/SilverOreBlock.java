...
import eu.freecluster.bloodieysart.superores.item.SilverIngotItem;
import eu.freecluster.bloodieysart.superores.SuperoresModElements;

@SuperoresModElements.ModElement.Tag
public class SilverOreBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:silver_ore")
	public static final Block block = null;

	public SilverOreBlock(SuperoresModElements instance) {
		super(instance, 262);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("superores:silver_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("superores:silver_ore"), configuredFeature);
		}
	}
