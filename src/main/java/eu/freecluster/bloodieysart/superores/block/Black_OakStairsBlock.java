...
public class Black_OakStairsBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_stairs")
	public static final Block block = null;

	public Black_OakStairsBlock(SuperoresModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("black_oak_stairs");
		}
