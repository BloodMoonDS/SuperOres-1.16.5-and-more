...
public class PhinksStairsBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_stairs")
	public static final Block block = null;

	public PhinksStairsBlock(SuperoresModElements instance) {
		super(instance, 570);
	}
