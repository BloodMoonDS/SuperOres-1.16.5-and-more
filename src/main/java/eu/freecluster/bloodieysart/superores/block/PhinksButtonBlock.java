...
public class PhinksButtonBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_button")
	public static final Block block = null;

	public PhinksButtonBlock(SuperoresModElements instance) {
		super(instance, 575);
	}
