...
public class Black_OakPlanksBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_planks")
	public static final Block block = null;

	public Black_OakPlanksBlock(SuperoresModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_oak_planks");
		}
