...
public class OmniacBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:omniac_block")
	public static final Block block = null;

	public OmniacBlockBlock(SuperoresModElements instance) {
		super(instance, 449);
	}
