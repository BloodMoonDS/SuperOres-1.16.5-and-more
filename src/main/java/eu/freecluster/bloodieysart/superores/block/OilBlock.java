...
public class OilBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:oil")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("superores:oil_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public OilBlock(SuperoresModElements instance) {
		super(instance, 259);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("superores:blocks/oil"), new ResourceLocation("superores:blocks/oil_flow")).luminosity(0)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("superores:oil_lakes"), configuredFeature);
		}
	}
