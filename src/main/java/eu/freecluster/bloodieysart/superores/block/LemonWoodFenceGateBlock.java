...
public class LemonWoodFenceGateBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_fence_gate")
	public static final Block block = null;

	public LemonWoodFenceGateBlock(SuperoresModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_fence_gate");
		}
