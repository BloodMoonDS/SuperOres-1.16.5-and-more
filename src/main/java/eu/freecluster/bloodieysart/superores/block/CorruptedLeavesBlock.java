...
public class CorruptedLeavesBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:corrupted_leaves")
	public static final Block block = null;

	public CorruptedLeavesBlock(SuperoresModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("corrupted_leaves");
		}
