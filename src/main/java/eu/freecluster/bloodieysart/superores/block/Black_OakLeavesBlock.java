...
public class Black_OakLeavesBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_leaves")
	public static final Block block = null;

	public Black_OakLeavesBlock(SuperoresModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("black_oak_leaves");
		}
