...
public class HarminiumBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:harminium_block")
	public static final Block block = null;

	public HarminiumBlockBlock(SuperoresModElements instance) {
		super(instance, 365);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("harminium_block");
		}
