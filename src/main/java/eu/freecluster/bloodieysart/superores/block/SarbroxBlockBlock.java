...
public class SarbroxBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:sarbrox_block")
	public static final Block block = null;

	public SarbroxBlockBlock(SuperoresModElements instance) {
		super(instance, 407);
	}
