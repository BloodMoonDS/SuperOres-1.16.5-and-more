...
public class PhinksWoodBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_wood")
	public static final Block block = null;

	public PhinksWoodBlock(SuperoresModElements instance) {
		super(instance, 566);
	}
