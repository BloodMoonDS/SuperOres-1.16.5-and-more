...
public class NickelBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:nickel_block")
	public static final Block block = null;

	public NickelBlockBlock(SuperoresModElements instance) {
		super(instance, 47);
	}
