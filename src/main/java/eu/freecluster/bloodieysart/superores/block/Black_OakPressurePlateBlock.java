...
public class Black_OakPressurePlateBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_pressure_plate")
	public static final Block block = null;

	public Black_OakPressurePlateBlock(SuperoresModElements instance) {
		super(instance, 208);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("black_oak_pressure_plate");
		}
