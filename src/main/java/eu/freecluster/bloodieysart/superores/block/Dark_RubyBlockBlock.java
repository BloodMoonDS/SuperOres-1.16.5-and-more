...
public class Dark_RubyBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:dark_ruby_block")
	public static final Block block = null;

	public Dark_RubyBlockBlock(SuperoresModElements instance) {
		super(instance, 332);
	}
