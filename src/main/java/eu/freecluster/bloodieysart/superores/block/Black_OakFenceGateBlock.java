...
public class Black_OakFenceGateBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_fence_gate")
	public static final Block block = null;

	public Black_OakFenceGateBlock(SuperoresModElements instance) {
		super(instance, 207);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("black_oak_fence_gate");
		}
