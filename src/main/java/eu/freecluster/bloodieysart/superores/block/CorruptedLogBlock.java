...
public class CorruptedLogBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:corrupted_log")
	public static final Block block = null;

	public CorruptedLogBlock(SuperoresModElements instance) {
		super(instance, 181);
	}
