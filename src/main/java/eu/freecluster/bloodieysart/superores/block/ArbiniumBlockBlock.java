...
public class ArbiniumBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:arbinium_block")
	public static final Block block = null;

	public ArbiniumBlockBlock(SuperoresModElements instance) {
		super(instance, 491);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("arbinium_block");
		}
