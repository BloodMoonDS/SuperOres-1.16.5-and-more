...
public class PhinksFenceBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:phinks_fence")
	public static final Block block = null;

	public PhinksFenceBlock(SuperoresModElements instance) {
		super(instance, 572);
	}
