...
public class BlastFlowersBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:blast_flowers")
	public static final Block block = null;

	public BlastFlowersBlock(SuperoresModElements instance) {
		super(instance, 231);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blast_flowers"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("superores:blast_flowers"), configuredFeature);
		}
	}
