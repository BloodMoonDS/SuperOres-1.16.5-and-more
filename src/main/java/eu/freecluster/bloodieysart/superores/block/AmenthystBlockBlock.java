...
public class AmenthystBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:amenthyst_block")
	public static final Block block = null;

	public AmenthystBlockBlock(SuperoresModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amenthyst_block");
		}
