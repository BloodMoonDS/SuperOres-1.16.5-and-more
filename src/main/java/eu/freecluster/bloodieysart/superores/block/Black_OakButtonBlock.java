...
public class Black_OakButtonBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_button")
	public static final Block block = null;

	public Black_OakButtonBlock(SuperoresModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("black_oak_button");
		}
