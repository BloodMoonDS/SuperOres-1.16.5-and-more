...
public class LemonWoodPlanksBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_planks")
	public static final Block block = null;

	public LemonWoodPlanksBlock(SuperoresModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_planks");
		}
