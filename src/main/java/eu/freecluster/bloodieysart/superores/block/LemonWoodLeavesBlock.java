...
public class LemonWoodLeavesBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:lemon_wood_leaves")
	public static final Block block = null;

	public LemonWoodLeavesBlock(SuperoresModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("lemon_wood_leaves");
		}
