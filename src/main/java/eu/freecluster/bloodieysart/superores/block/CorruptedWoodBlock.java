...
public class CorruptedWoodBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:corrupted_wood")
	public static final Block block = null;

	public CorruptedWoodBlock(SuperoresModElements instance) {
		super(instance, 180);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("corrupted_wood");
		}
