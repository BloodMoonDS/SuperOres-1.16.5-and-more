...
public class TimeWoodFenceGateBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:time_wood_fence_gate")
	public static final Block block = null;

	public TimeWoodFenceGateBlock(SuperoresModElements instance) {
		super(instance, 240);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("time_wood_fence_gate");
		}
