...
public class Black_OakWoodBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_wood")
	public static final Block block = null;

	public Black_OakWoodBlock(SuperoresModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_oak_wood");
		}
