...
public class Black_OakLogBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:black_oak_log")
	public static final Block block = null;

	public Black_OakLogBlock(SuperoresModElements instance) {
		super(instance, 201);
	}
