...
public class OvimiumBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:ovimium_block")
	public static final Block block = null;

	public OvimiumBlockBlock(SuperoresModElements instance) {
		super(instance, 386);
	}
