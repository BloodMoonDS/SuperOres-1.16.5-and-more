...
public class TimeWoodStairsBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:time_wood_stairs")
	public static final Block block = null;

	public TimeWoodStairsBlock(SuperoresModElements instance) {
		super(instance, 237);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("time_wood_stairs");
		}
