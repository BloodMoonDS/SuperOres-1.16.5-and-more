...
public class OdrimiumBlockBlock extends SuperoresModElements.ModElement {
	@ObjectHolder("superores:odrimium_block")
	public static final Block block = null;

	public OdrimiumBlockBlock(SuperoresModElements instance) {
		super(instance, 111);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("odrimium_block");
		}
